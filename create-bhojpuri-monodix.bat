@echo off
REM Bhojpuri Monodix Creator Script
REM This script generates Apertium monodix format from Bhojpuri data

echo Creating Bhojpuri monodix dictionary...

set INPUT_DIR=input\Bhojpuri-Magahi-and-Maithili-Linguistic-Resources\bhojpuri
set OUTPUT_FILE=bhojpuri-monodix.dix
